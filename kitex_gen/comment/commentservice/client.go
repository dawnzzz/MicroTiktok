...
type Client interface {
	...
	CommentDelete(ctx context.Context, req *comment.CommentDeleteRequest, callOptions ...callopt.Option) (r *comment.CommentDeleteResponse, err error)
...
func (p *kCommentServiceClient) CommentDelete(ctx context.Context, req *comment.CommentDeleteRequest, callOptions ...callopt.Option) (r *comment.CommentDeleteResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
