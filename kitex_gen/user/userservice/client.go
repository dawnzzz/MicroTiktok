...
type Client interface {
	...
	GetUserInfo(ctx context.Context, req *user.GetUserRequest, callOptions ...callopt.Option) (r *user.GetUserResponse, err error)
	BatchGetUserInfo(ctx context.Context, req *user.BatchGetUserRequest, callOptions ...callopt.Option) (r *user.BatchGetUserResonse, err error)
}
...
func (p *kUserServiceClient) GetUserInfo(ctx context.Context, req *user.GetUserRequest, callOptions ...callopt.Option) (r *user.GetUserResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetUserInfo(ctx, req)
}

func (p *kUserServiceClient) BatchGetUserInfo(ctx context.Context, req *user.BatchGetUserRequest, callOptions ...callopt.Option) (r *user.BatchGetUserResonse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
