...
func (p *GetUserRequest) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "get_user_request")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *GetUserRequest) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("get_user_request")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *GetUserResponse) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "get_user_response")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *GetUserResponse) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("get_user_response")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *BatchGetUserRequest) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_BatchGetUserRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *BatchGetUserRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *BatchGetUserRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *BatchGetUserRequest) FastWrite(buf []byte) int {
	return 0
}

func (p *BatchGetUserRequest) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "batch_get_user_request")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *BatchGetUserRequest) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("batch_get_user_request")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *BatchGetUserRequest) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "viewer_id", thrift.I64, 1)
	offset += bthrift.Binary.WriteI64(buf[offset:], p.ViewerId)
...
func (p *BatchGetUserRequest) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *BatchGetUserRequest) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("viewer_id", thrift.I64, 1)
	l += bthrift.Binary.I64Length(p.ViewerId)
...
func (p *BatchGetUserRequest) field2Length() int {
	l := 0
...
func (p *BatchGetUserResonse) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_BatchGetUserResonse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *BatchGetUserResonse) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *BatchGetUserResonse) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *BatchGetUserResonse) FastWrite(buf []byte) int {
	return 0
}

func (p *BatchGetUserResonse) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "batch_get_user_resonse")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *BatchGetUserResonse) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("batch_get_user_resonse")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *BatchGetUserResonse) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "base_resp", thrift.STRUCT, 1)
	offset += p.BaseResp.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
...
func (p *BatchGetUserResonse) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *BatchGetUserResonse) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("base_resp", thrift.STRUCT, 1)
	l += p.BaseResp.BLength()
	l += bthrift.Binary.FieldEndLength()
...
func (p *BatchGetUserResonse) field2Length() int {
	l := 0
