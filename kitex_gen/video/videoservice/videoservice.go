...
func (p *kClient) GetPublishedVideoList(ctx context.Context, req *video.GetPublishedListRequest) (r *video.GetPublishedListResponse, err error) {
...
func (p *kClient) GetFavoriteVideoList(ctx context.Context, req *video.GetFavoriteListRequest) (r *video.GetFavoriteListResponse, err error) {
